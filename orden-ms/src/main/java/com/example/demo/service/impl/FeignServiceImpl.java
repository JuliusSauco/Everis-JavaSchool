...
public class FeignServiceImpl implements FeignService {
	...
	@HystrixCommand(fallbackMethod = "actualizarStockDefecto", groupKey = "obtenerCantidadStockProducto", commandKey = "obtenerCantidadStockProducto", threadPoolKey = "obtenerCantidadStockProducto", 
			commandProperties = {
			@HystrixProperty(name = "execution.isolation.thread.timeoutInMilliseconds", value = "3000"),
			@HystrixProperty(name = "circuitBreaker.requestVolumeThreshold", value = "5")}, 
			threadPoolProperties = {
	...
	public void actualizarStockDefecto(){

	}
	
	@HystrixCommand(fallbackMethod = "actualizarStockOrdenBorradoDefecto", groupKey = "obtenerCantidadStockProducto", commandKey = "obtenerCantidadStockProducto", threadPoolKey = "obtenerCantidadStockProducto", 
			commandProperties = {
			@HystrixProperty(name = "execution.isolation.thread.timeoutInMilliseconds", value = "3000"),
			@HystrixProperty(name = "circuitBreaker.requestVolumeThreshold", value = "5")}, 
			threadPoolProperties = {
	...
	public void actualizarStockOrdenBorradoDefecto() {
